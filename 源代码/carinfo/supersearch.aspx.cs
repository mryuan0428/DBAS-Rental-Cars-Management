...
namespace WebApplication4
{
	...
	/// supersearch1 的摘要说明。
	/// </summary>
	public partial class supersearch1 : System.Web.UI.Page
	{
		...
		protected hlbd.车辆信息.DataSet2 dataSet21;
		...
		protected void Page_Load(object sender, System.EventArgs e)
		{
			if (!IsPostBack)
			{
				sqlDataAdapter1.Fill(dataSet21,"carinfo");
				this.DataBind();
			}// 在此处放置用户代码以初始化页面
		}
		...
		{   
			...
			this.dataSet21 = new hlbd.车辆信息.DataSet2();
			...
			// sqlConnection1
			// 
			/*this.sqlConnection1.ConnectionString = "workstation id=HEJIA;packet size=4096;user id=sa;pwd=;integrated security=SSPI;da" +
				"ta source=hejia;persist security info=False;initial catalog=hlbd";*/
...
//			DataGrid1.DataSource=CreateSource ("select * from carinfo","carinfo");
//			DataGrid1.DataBind ();
//		}
//		public ICollection CreateSource(string sqlstr,string dTable)
//		{
//			SqlConnection conn = new SqlConnection ("server = team1-004;Database =hlbd;user id = sa;pwd = ;");
...
//		}
		...
		protected void Button1_Click(object sender, System.EventArgs e)
		{
			...
			{
				query1 ="车辆类型="+"'"+TextBox1.Text+"'";
			}
			if (DropDownList1.SelectedIndex==1)
			{
				query1 ="车辆颜色="+"'"+TextBox1.Text+"'";
			}
			if(DropDownList1.SelectedIndex==2)
			{
				query1 ="车辆状态="+"'"+TextBox1.Text+"'";
			}
			if(DropDownList1.SelectedIndex==3)
			{
				query1 ="车辆名称="+"'"+TextBox1.Text+"'";
			}
			if(DropDownList1.SelectedIndex==4)
			{
				query1 ="业务部编号="+"'"+TextBox1.Text+"'";
			}
			if(DropDownList1.SelectedIndex==5)
			{
				query1 ="公里数="+"'"+TextBox1.Text+"'";
			}
			if(DropDownList1.SelectedIndex==6)
			{
				query1 ="保险类型="+"'"+TextBox1.Text+"'";
			}
			if(DropDownList1.SelectedIndex==7)
			{
				query1 ="保险公司="+"'"+TextBox1.Text+"'";
			}
			if(DropDownList1.SelectedIndex==8)
			{
				query1 ="油类型="+"'"+TextBox1.Text+"'";
			}
			...
			{
				query2 ="车辆类型="+"'"+TextBox2.Text+"'";
			}
			if (DropDownList2.SelectedIndex==1)
			{
				query2 ="车辆颜色="+"'"+TextBox2.Text+"'";
			}
			if(DropDownList2.SelectedIndex==2)
			{
				query2 ="车辆状态="+"'"+TextBox2.Text+"'";
			}
			if(DropDownList2.SelectedIndex==3)
			{
				query2 ="车辆名称="+"'"+TextBox2.Text+"'";
			}
			if(DropDownList2.SelectedIndex==4)
			{
				query2 ="业务部编号="+"'"+TextBox2.Text+"'";
			}
			if(DropDownList2.SelectedIndex==5)
			{
				query2 ="公里数="+"'"+TextBox2.Text+"'";
			}
			if(DropDownList2.SelectedIndex==6)
			{
				query2 ="保险类型="+"'"+TextBox2.Text+"'";
			}
			if(DropDownList2.SelectedIndex==7)
			{
				query2 ="保险公司="+"'"+TextBox2.Text+"'";
			}
			if(DropDownList2.SelectedIndex==8)
			{
				query2 ="油类型="+"'"+TextBox2.Text+"'";
			}

			if(TextBox1.Text=="")
				sqlDataAdapter1.SelectCommand.CommandText = "select * from carinfo where "+query2;
			else
				if(TextBox2.Text=="")
				sqlDataAdapter1.SelectCommand.CommandText = "select * from carinfo where "+query1;
			else
				sqlDataAdapter1.SelectCommand.CommandText = "select * from carinfo where "+query1+ " and " +query2;
