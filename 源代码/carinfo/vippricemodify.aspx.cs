...
{
	/// <summary>
	/// vippricemodify 的摘要说明。
	/// </summary>
	public partial class vippricemodify : System.Web.UI.Page
	{
		...
		protected void Button2_Click(object sender, System.EventArgs e)
		{
			...
			string sqlcar="insert into carmodel (车辆名称,车辆类型,会员限制里程数目,会员租车押金,会员超驶收费,"+downlist1+","+downlist2+") values ('"+downlist3+"','"+downlist4+"','"+txt_1+"',convert(money,'"+txt_2+"'),convert(money,'"+txt_3+"'),convert(money,'"+txt_4+"'),convert(money,'"+txt_5+"'))";
			conn.Open();
