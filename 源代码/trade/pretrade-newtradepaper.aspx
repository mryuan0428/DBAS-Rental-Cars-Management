	...
	<body>
		<form id="Form1" method="post" runat="server">
			<asp:label id="Label1" style="Z-INDEX: 101; LEFT: 400px; POSITION: absolute; TOP: 8px" runat="server"
				Font-Bold="True" Font-Size="Large" ForeColor="Blue" Width="184px">汽车租赁登记表</asp:label><asp:label id="Label32" style="Z-INDEX: 111; LEFT: 72px; POSITION: absolute; TOP: 744px" runat="server"
				Width="824px">担保人声明：本人自愿为承租方承担连带责任担保，当承租方不能偿还因租用华磊邦得汽车租赁有限公司车辆 所发生的直接及间接经济损失时，本人自愿放弃抗辩权并承担承租方所未偿还的全部债务。</asp:label><asp:label id="Label31" style="Z-INDEX: 110; LEFT: 728px; POSITION: absolute; TOP: 784px" runat="server"
				Width="168px">服务投诉电话      64275689</asp:label><asp:label id="Label27" style="Z-INDEX: 105; LEFT: 80px; POSITION: absolute; TOP: 56px" runat="server">租赁车号：</asp:label><asp:label id="Label26" style="Z-INDEX: 103; LEFT: 464px; POSITION: absolute; TOP: 56px" runat="server">合同编号：</asp:label><asp:label id="Label25" style="Z-INDEX: 104; LEFT: 680px; POSITION: absolute; TOP: 56px" runat="server"
				Width="80px">出表日期：</asp:label>
			<table style="Z-INDEX: 102; LEFT: 72px; WIDTH: 824px; POSITION: absolute; TOP: 80px; HEIGHT: 660px"
				...
				<TR bgColor="#ffffff">
					<TD colSpan="6">&nbsp; 4. 承租人还车时，需交纳违章押金壹仟元整，自还车之日 20 
						天后，如所租车辆无违章行为，违章押金如数退还。如有违章且拒不处理的，将扣除本车辆所造成的违章罚款，并承担因本车辆处理违章期间所产生的租金及相关损失费用。
					</TD>
				</TR>
				<TR bgColor="#ffffff">
					<TD height="27">车辆车号</TD>
					<TD width="17%">&nbsp;
