<%@ Page language="c#" Inherits="client.client.del_company" CodeFile="del_company.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>del_company</title>
	...
	<body background="file:///C:\Inetpub\wwwroot\HLBD\logo2.gif">
		<form id="Form1" method="post" runat="server">
			<FONT face="黑体">
				<TABLE id="Table2" style="Z-INDEX: 113; LEFT: 16px; POSITION: absolute; TOP: 40px" borderColor="#669966"
					...
					<TR>
						...
						<TD style="WIDTH: 275px">
							<DIV align="center">
								<asp:textbox id="name" runat="server" Enabled="False" Width="161px" Font-Names="Arial"></asp:textbox><FONT size="2"></FONT></DIV>
						</TD>
					...
					<TR>
						...
						<TD style="WIDTH: 275px">
							<DIV align="center">
								<asp:textbox id="bussinessid" runat="server" Enabled="False" Width="160px" Font-Names="Arial"></asp:textbox></DIV>
						</TD>
						<TD style="WIDTH: 65px">
					...
					<TR>
						...
						<TD style="WIDTH: 275px">
							<DIV align="center"><FONT face="黑体">
									<asp:textbox id="bank" runat="server" Enabled="False" Width="160px" Font-Names="Arial"></asp:textbox><FONT size="2"></FONT></FONT></DIV>
						</TD>
						<TD style="WIDTH: 65px">
					...
					<TR>
						...
						<TD style="WIDTH: 275px">
							<DIV align="center"><FONT face="黑体" size="2">
									<asp:textbox id="character" runat="server" Enabled="False" Width="161px" Font-Names="Arial"></asp:textbox></FONT></DIV>
						</TD>
						<TD style="WIDTH: 65px">
					...
					<TR>
						...
						<TD style="WIDTH: 275px" align="left">
							<DIV align="center"><FONT face="黑体" size="2">&nbsp;
									<asp:textbox id="phone" runat="server" Enabled="False" Width="158px" Font-Names="Arial"></asp:textbox>&nbsp;</FONT></DIV>
						</TD>
						<TD style="WIDTH: 65px">
					...
					<TR>
						...
						<TD style="WIDTH: 275px">
							<DIV align="center"><FONT face="黑体" size="2">&nbsp;
									<asp:textbox id="fax" runat="server" Enabled="False" Width="161px" Font-Names="Arial"></asp:textbox>&nbsp;</FONT></DIV>
						</TD>
						<TD style="WIDTH: 65px">
					...
					<TR>
						...
						<TD style="WIDTH: 275px; HEIGHT: 12px" align="center">
							<DIV align="center"><FONT face="黑体">
									<asp:RadioButtonList id="member" runat="server" Enabled="False" Width="5px" Font-Size="X-Small" RepeatDirection="Horizontal"
										Font-Names="Arial">
					...
					<TR>
						...
						<TD style="WIDTH: 275px">
							<DIV align="center"><FONT style="FONT-SIZE: 10pt; FONT-FAMILY: Arial" face="黑体">&nbsp;
									<asp:TextBox id="memberstart" runat="server" Enabled="False" Width="155px" Font-Names="Arial"></asp:TextBox>(1980-06-25)</FONT>
							</DIV>
						</TD>
						<TD style="WIDTH: 65px">
						...
						<TD>
							<DIV align="center"><FONT class="style4" style="FONT-SIZE: 10pt; FONT-FAMILY: Arial" face="黑体" size="2">
					...
					<TR>
						...
						<TD style="HEIGHT: 83px" colSpan="3">
							<DIV align="center"><FONT face="黑体" size="2"></FONT></DIV>
							<DIV align="center"><FONT face="黑体" size="2">
									<asp:TextBox id="note" runat="server" Enabled="False" Width="530px" Height="57px" TextMode="MultiLine"
					...
					<TR>
						<TD align="center" colSpan="4">
							<asp:Label id="Label3" runat="server" Font-Names="Arial">请输入操作员验证码</asp:Label><FONT face="宋体">&nbsp;&nbsp;
							</FONT>
							<asp:TextBox id="keyword" runat="server" Width="94px" TextMode="Password"></asp:TextBox><FONT face="宋体">&nbsp;&nbsp;
							</FONT>
					...
					<TR>
						<TD align="left" colSpan="4"><FONT face="黑体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
								&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;
								<asp:Button id="del" runat="server" Text="删除" Enabled="False" Font-Names="Arial" onclick="del_Click"></asp:Button>&nbsp;&nbsp;&nbsp;</FONT><FONT face="黑体">&nbsp;&nbsp;&nbsp;&nbsp;</FONT><FONT face="黑体">&nbsp;</FONT>
							<asp:Button id="cancel" runat="server" Text="取消" Font-Names="Arial" onclick="cancel_Click"></asp:Button><FONT face="黑体" style="FONT-FAMILY: Arial">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
								&nbsp;&nbsp;&nbsp;&nbsp; &nbsp; &nbsp;&nbsp;&nbsp;&nbsp;录入时间&nbsp; </FONT>
							<asp:textbox id="rcd" runat="server" Enabled="False" Width="104px" Font-Names="Arial"></asp:textbox></TD>
					</TR>
				</TABLE>
				<asp:label id="Label1" style="Z-INDEX: 107; LEFT: 280px; POSITION: absolute; TOP: 8px" runat="server"
					Font-Size="Large" Font-Bold="True" Font-Names="Arial">删除公司客户信息</asp:label>
				<asp:label id="Label2" style="Z-INDEX: 109; LEFT: 560px; POSITION: absolute; TOP: 16px" runat="server"
					Width="75px" Font-Size="Small" Height="8px" Font-Names="Arial">客户编号</asp:label>
				<asp:textbox id="userid" style="Z-INDEX: 110; LEFT: 648px; POSITION: absolute; TOP: 16px" runat="server"
					Enabled="False" Width="128px" Font-Names="Arial"></asp:textbox>
				<TABLE id="Table1" style="Z-INDEX: 112; LEFT: 392px; WIDTH: 64px; POSITION: absolute; TOP: 720px; HEIGHT: 21px"
