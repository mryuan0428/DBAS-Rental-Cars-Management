<%@ Page language="c#" Inherits="client.change_company" CodeFile="change_company.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>change_company</title>
	...
	<body background="..\logo2.gif">
		<form id="Form1" method="post" runat="server">
			...
			<asp:label id="Label1" style="Z-INDEX: 113; LEFT: 280px; POSITION: absolute; TOP: 8px" runat="server"
				Font-Bold="True" Font-Size="Large" Font-Names="Arial">公司客户会员转换</asp:label>
			<TABLE id="Table2" style="Z-INDEX: 114; LEFT: 16px; POSITION: absolute; TOP: 40px" borderColor="#669966"
				...
				<TR>
					...
					<TD style="HEIGHT: 83px" colSpan="3">
						<DIV align="center"><FONT face="黑体" size="2"></FONT></DIV>
						<DIV align="center"><FONT face="黑体" size="2">
								<asp:TextBox id="note" runat="server" Width="530px" Enabled="False" TextMode="MultiLine" Height="57px"
				...
				<TR>
					<TD align="left" colSpan="4"><FONT face="黑体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
							<asp:Button id="change" runat="server" Text="转换" Enabled="False" Font-Names="Arial" onclick="change_Click"></asp:Button>&nbsp;&nbsp;
						</FONT>&nbsp;<FONT face="黑体"> &nbsp;&nbsp;&nbsp; </FONT>
						<asp:Button id="sure" runat="server" Enabled="False" Text="确认" Font-Names="Arial" onclick="sure_Click"></asp:Button><FONT face="黑体">&nbsp;&nbsp; 
							&nbsp; &nbsp;&nbsp;&nbsp;</FONT>
			...
			<asp:label id="Label2" style="Z-INDEX: 115; LEFT: 560px; POSITION: absolute; TOP: 16px" runat="server"
				Font-Size="Small" Width="75px" Height="8px" Font-Names="Arial">客户编号</asp:label>
			<asp:textbox id="userid" style="Z-INDEX: 116; LEFT: 648px; POSITION: absolute; TOP: 16px" runat="server"
