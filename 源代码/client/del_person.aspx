<%@ Page language="c#" Inherits="client.client.del_person" CodeFile="del_person.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>del_person</title>
	...
	<body background="file:///C:\Inetpub\wwwroot\HLBD\logo2.gif">
		<form id="Form1" method="post" runat="server">
				...
				<TABLE id="Table1" style="Z-INDEX: 106; LEFT: 16px; WIDTH: 736px; POSITION: absolute; TOP: 40px; HEIGHT: 657px"
					...
					<TBODY>
						...
						<TR>
							...
							<TD style="WIDTH: 148px"><FONT face="宋体"></FONT></TD>
							<TD></TD>
						</TR>
						<TR>
						...
						<TR>
							<TD style="FONT-SIZE: 11pt; FONT-FAMILY: Arial" align="center" colSpan="4">
			...
			<asp:Button id="Button2" runat="server" Text="确定" onclick="Button2_Click"></asp:Button></TD></TR>
			<TR>
				<TD style="FONT-SIZE: 11pt; FONT-FAMILY: Arial" align="left" colSpan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
					&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
					&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
					<asp:button id="del" runat="server" Width="49px" Font-Size="X-Small" Text="删除" Font-Names="Arial"
						Enabled="False" onclick="del_Click"></asp:button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					<asp:Button id="cancel" runat="server" Width="52px" Font-Size="X-Small" Text="取消" Font-Names="Arial" onclick="cancel_Click"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
					&nbsp;&nbsp;&nbsp;登记时间
					<asp:textbox id="rcd" runat="server" Enabled="False" Width="104px" Font-Names="Arial"></asp:textbox></TD>
			</TR>
			</TABLE> 
			</TBODY><FONT face="黑体">
				<asp:label id="Label1" style="Z-INDEX: 101; LEFT: 272px; POSITION: absolute; TOP: 8px" runat="server"
					Font-Size="Large" Font-Bold="True" Font-Names="Arial">删除个人客户信息</asp:label></FONT>
