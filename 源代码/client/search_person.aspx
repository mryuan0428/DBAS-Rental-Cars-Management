<%@ Page language="c#" Inherits="client.client.search_person" CodeFile="search_person.aspx.cs" %>
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.0 Transitional//EN" >
<HTML>
	<HEAD>
		<title>search_person</title>
	...
	<body background="file:///C:\Inetpub\wwwroot\HLBD\logo2.gif">
		<form id="Form1" method="post" runat="server">
			<FONT face="黑体"></FONT>
			<asp:label id="Label1" style="Z-INDEX: 106; LEFT: 280px; POSITION: absolute; TOP: 8px" runat="server"
				Font-Bold="True" Font-Size="Large" Font-Names="Arial">查询个人客户信息</asp:label>
			<TABLE id="Table1" style="Z-INDEX: 107; LEFT: 16px; WIDTH: 736px; POSITION: absolute; TOP: 40px; HEIGHT: 657px"
				...
				<TR>
					<TD class="style1" style="FONT-SIZE: 9pt; WIDTH: 107px; FONT-FAMILY: Arial; HEIGHT: 26px"
						align="center">姓名</TD>
					<TD style="WIDTH: 187px; HEIGHT: 26px" align="center">
				...
				<TR>
					<TD class="style1" style="FONT-SIZE: 9pt; WIDTH: 107px; FONT-FAMILY: Arial; HEIGHT: 38px"
						align="center">性别</TD>
					<TD class="style1" style="WIDTH: 187px; HEIGHT: 38px" align="center">
						<asp:radiobuttonlist id="sex" runat="server" Font-Size="X-Small" Enabled="False" Width="56px" Height="2px"
							RepeatDirection="Horizontal" Font-Names="Arial">
							<asp:ListItem Value="1" Selected="True">男</asp:ListItem>
							<asp:ListItem Value="2">女</asp:ListItem>
						</asp:radiobuttonlist></TD>
					<TD class="style1" style="FONT-SIZE: 9pt; WIDTH: 148px; FONT-FAMILY: Arial; HEIGHT: 38px"
						align="center">出生日期</TD>
					<TD class="style1" style="FONT-SIZE: 10pt; HEIGHT: 38px" align="left">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
				...
				<TR>
					<TD class="style1" style="FONT-SIZE: 9pt; WIDTH: 107px; FONT-FAMILY: Arial; HEIGHT: 2px"
						align="center">学历</TD>
					<TD style="WIDTH: 187px; HEIGHT: 2px" align="center">
				...
				<TR>
					...
					<TD style="WIDTH: 187px; HEIGHT: 7px" align="center">
				...
				<TR>
					...
					<TD class="style1" style="FONT-SIZE: 10pt; WIDTH: 148px; HEIGHT: 2px" align="center"><FONT style="FONT-FAMILY: Arial" face="宋体">客户照片</FONT></TD>
					<TD style="HEIGHT: 7px" align="center">
						<asp:Button id="photo" runat="server" Font-Names="Arial" Text="查看照片" onclick="photo_Click"></asp:Button></TD>
				</TR>
				<TR>
				...
				<TR>
					<TD bgColor="#0080c0" colSpan="4">
						<DIV align="center"><STRONG><FONT face="黑体" color="#ffff00" size="2">会 员</FONT></STRONG></DIV>
					</TD>
				</TR>
				<TR>
					...
					<TD class="style1" style="WIDTH: 187px" align="center">
						<asp:radiobuttonlist id="member" runat="server" Font-Size="X-Small" Enabled="False" Width="16px" Height="16px"
							RepeatDirection="Horizontal" Font-Names="Arial">
				...
				<TR>
					...
					<TD class="style1" style="FONT-SIZE: 10pt; WIDTH: 187px; FONT-FAMILY: Arial">&nbsp;
				...
				<TR>
					<TD style="FONT-SIZE: 11pt; FONT-FAMILY: Arial" align="left" colSpan="4">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:Button id="mod" runat="server" Text="修改" Font-Names="Arial" onclick="mod_Click"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:Button id="del" runat="server" Text="删除" Font-Names="Arial" onclick="del_Click"></asp:Button>&nbsp;&nbsp;&nbsp;&nbsp; 
						&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:button id="sure" runat="server" Width="49px" Text="确定" Font-Names="Arial" onclick="sure_Click"></asp:button>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;登记时间
						<asp:textbox id="rcd" runat="server" Enabled="False" Width="104px" Font-Names="Arial"></asp:textbox></TD>
				</TR>
			</TABLE>
			<asp:label id="Label2" style="Z-INDEX: 108; LEFT: 544px; POSITION: absolute; TOP: 16px" runat="server"
				Font-Size="Small" Width="75px" Height="8px" Font-Names="Arial">客户编号</asp:label>
			<asp:textbox id="userid" style="Z-INDEX: 109; LEFT: 624px; POSITION: absolute; TOP: 16px" runat="server"
				Enabled="False" Width="128px" Font-Names="Arial"></asp:textbox>
			<TABLE id="Table2" style="Z-INDEX: 110; LEFT: 360px; WIDTH: 72px; POSITION: absolute; TOP: 800px; HEIGHT: 24px"
