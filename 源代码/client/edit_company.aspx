<%@ Page language="c#" Inherits="client.client.edit_company" CodeFile="edit_company.aspx.cs" %>
	...
	<body background="file:///C:\Inetpub\wwwroot\HLBD\logo2.gif">
		<form id="Form1" method="post" runat="server">
			...
			<asp:label id="Label1" style="Z-INDEX: 107; LEFT: 280px; POSITION: absolute; TOP: 8px" runat="server"
				Font-Bold="True" Font-Size="Large" Font-Names="Arial">修改公司客户信息</asp:label>
			<TABLE id="Table2" style="Z-INDEX: 108; LEFT: 16px; POSITION: absolute; TOP: 40px" borderColor="#669966"
				...
				<TR>
					<TD>
						<DIV align="center"><SPAN class="style4"><FONT size="2">银行名称</FONT></SPAN></DIV>
					</TD>
					<TD style="WIDTH: 275px">
				...
				<TR>
					<TD style="HEIGHT: 24px" bgColor="#0080c0" colSpan="4">
						<DIV align="center"><FONT face="黑体" color="#ffff00" size="2"><STRONG style="FONT-FAMILY: Arial">会 
									员 </STRONG></FONT>
						</DIV>
					</TD>
				</TR>
				<TR>
					...
					<TD style="WIDTH: 275px; HEIGHT: 12px" align="center">
						<DIV align="center"><FONT face="黑体">
								<asp:RadioButtonList id="member" runat="server" Font-Size="X-Small" Width="5px" RepeatDirection="Horizontal"
				...
				<TR>
					...
					<TD style="HEIGHT: 83px" colSpan="3">
						<DIV align="center"><FONT face="黑体" size="2"></FONT></DIV>
						<DIV align="center"><FONT face="黑体" size="2">
								<asp:TextBox id="note" runat="server" Width="530px" TextMode="MultiLine" Height="57px" Wrap="False"
									Enabled="False" Font-Names="Arial"></asp:TextBox>&nbsp; </FONT>
						</DIV>
					</TD>
				</TR>
				<TR>
					<TD align="center" colSpan="4"><FONT face="宋体">
							<asp:Label id="Label3" runat="server" Font-Names="Arial">请输入操作员验证码</asp:Label>&nbsp;&nbsp;</FONT>
				...
				<TR>
					<TD align="left" colSpan="4"><FONT face="黑体">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; 
							&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;
							<asp:Button id="mod" runat="server" Text="修改" Font-Names="Arial" Enabled="False" onclick="mod_Click"></asp:Button>&nbsp;&nbsp;
						</FONT>&nbsp;<FONT face="黑体"> &nbsp;&nbsp;&nbsp; </FONT>
						<asp:Button id="sure" runat="server" Text="提交" Enabled="False" Font-Names="Arial" onclick="sure_Click"></asp:Button><FONT face="黑体">&nbsp;&nbsp; 
							&nbsp; &nbsp;&nbsp;&nbsp;</FONT>
						<asp:Button id="cancel" runat="server" Text="取消" Font-Names="Arial" onclick="cancel_Click"></asp:Button><FONT face="黑体" style="FONT-FAMILY: Arial">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;录入时间&nbsp;
						</FONT>
			...
			<TABLE id="Table1" style="Z-INDEX: 112; LEFT: 392px; WIDTH: 64px; POSITION: absolute; TOP: 760px; HEIGHT: 21px"
